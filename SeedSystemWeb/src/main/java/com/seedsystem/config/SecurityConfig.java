...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  /**
   * This method will enable httpSecurity and disable for HttpMethod.OPTIONS request and it will
   * skip the path "/webjars/springfox-swagger-ui/**", "/swagger-ui.html", "/error",
   * "/swagger-resources", "/swagger-resources/**", "/v2/api-docs", "/user/login".
   * 
   * @param http
   *          httpSecurity
   */
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    String[] excludePaths = {"/webjars/springfox-swagger-ui/**", "/configuration/ui",
        "/configuration/security", "/swagger-ui.html", "/error", "/swagger-resources",
        "/swagger-resources/**", "/v2/api-docs", "/user/login","/user/register", "/version",
        "/users/passwords/forget-password"};
  ...
  private CorsConfigurationSource corsConfigurationSource() {
    ...
    if (allowedOrigins == null || allowedOrigins.isEmpty() || allowedHeaders == null
